...
st.markdown("<h1 style='text-align: center;'>Auto Value Pro</h1>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center;'>A Vehicle Valuation Wizard</h3>", unsafe_allow_html=True)
st.write("This app predicts the price of a car you want to sell or buy. Try filling the details below:")
